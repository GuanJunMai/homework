    ...
    private void initHandlerMapping() {
        ...
        for (Map.Entry<String, Object> entry : ioc.entrySet()) {
            ...
            if (aClass.isAnnotationPresent(LagouSecurity.class)) {
                security = aClass.getAnnotation(LagouSecurity.class).value();
            }
            ...
            for (int i = 0; i < methods.length; i++) {
                ...
                if (method.isAnnotationPresent(LagouSecurity.class)) {
                    security = method.getAnnotation(LagouSecurity.class).value();
                }
...
//        method.invoke() //
        ...
        for (Map.Entry<String, String[]> param : parameterMap.entrySet()) {
            ...
            if (param.getKey().equals(Handler.USER_NAME)) {
                userName = value;
            }
        ...
        if (security != null && !security.equals(userName)) {
